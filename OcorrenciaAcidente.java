...
public class OcorrenciaAcidente {
	...
	public OcorrenciaAcidente(Integer idOcorrenciaAcidente, String fonte, String local, String bairro, String logradouro,
			Date dtAcidente, String causa) {
	...
	public void imprimirOcorrencia(OcorrenciaAcidente ocorrenciaAcidente) {
		...
		System.out.println("FONTE:         " +ocorrenciaAcidente.getFonte());
		System.out.println("LOCAL:         " +ocorrenciaAcidente.getLocal());
		System.out.println("BAIRRO:        " +ocorrenciaAcidente.getBairro());
		System.out.println("LOGRADOURO:    " +ocorrenciaAcidente.getLogradouro());
		System.out.println("DATA:          " +ocorrenciaAcidente.getDtAcidente());
